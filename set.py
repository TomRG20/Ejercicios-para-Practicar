""" Ejercicio de prueba
    ...
    Set. ¿Qué son?
    Son una estructura de datos similar a las listas, que permiten almacenar elementos con unas 
    diferencias:
...
# funcion len()
print("El tamaño de s es:", len(s3))
...
# devuelve la diferencia simetrica del conjunto con el s2 como un conjunto nuevo
print("La diferencia simetrica entre s1 y s2 es: ", s1.symmetric_difference(s2)) 

# Dos conjuntos A y B son disjuntos si no tienen elementos en común, es decir, la intersección de A y B
# es el conjunto vacío
print("Es un conjunto disjunto? : ",s1.isdisjoint(s2)) 

# devuelve true si el conjunto es subconjunto del s2
print("Es un subconjunto de s2? : ", s1.issubset(s2))

# devuelve true si el conjunto es superconjunto del s2
print("Es un superconjunto de s2? : ", s1.issuperset(s2)) 

# actualiza el conjunto tras realizar la union con el s2
print("El nuevo conjunto después de la unión es : ", s1.update(s2)) 

# actualiza el conjunto tras realizar la intersección con el s2
print("El nuevo conjunto después de la intersección es : ", s1.intersection_update(s2)) 

# actualiza el conjunto tras realizar la diferencia con el s2
print("El nuevo conjunto después de la diferencia es : ", s1.difference_update(s2)) 

# actualiza el conjunto tras realizar la diferencia simetrica con el s2
print("El nuevo conjunto después de la diferencia simetrica es : ", s1.symmetric_difference_update(s2))
